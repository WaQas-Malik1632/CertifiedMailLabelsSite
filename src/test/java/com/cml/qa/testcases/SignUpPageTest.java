...
public class SignUpPageTest extends TestBaseClass {
	...
	public void TC_CML_SS_020() throws IOException, InterruptedException {
		loginPage = signup.userRegistrationForm("LoggedNewsInTestSteveUsers", "Staging178", "Destiny Planners",
				"4678 James Martin " + "Circle", "Columbus, OH 43215", "US", "Florida", "43215", "46478",
				"2694558744", "LoggedNewsInTestSteveUserss@mailinator.com", "Pass@123", "Pass@123");

		//Validate email via mailinator
		dashboard = utilMailinator.MailinatorLinkVerificationAndLoginNewUser("Bestuseronesss@mailinator" +
			".com");
